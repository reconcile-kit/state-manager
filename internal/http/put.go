...
// @Param resource body dto.ResourceUpdateOpts{spec=map[string]string} true "Resource details"
// @Success 200 {object} dto.Resource{} "Resource updated" example={"id":1,"resource_group":"group1","kind":"type1","namespace":"ns1","name":"resource1","shard_id":"default","body":{"key":"new_value"},"labels":{"env":"dev"},"created_at":"2025-05-12T00:00:00Z","updated_at":"2025-05-12T01:00:00Z","version":2,"current_version":0}
...
// @Param namespace path string true "Namespace" example="ns1"
// @Param name path string true "Name" example="resource1"
// @Param resource body dto.ResourceUpdateStatusOpts{status=map[string]interface{}} true "Resource details"
// @Success 200 {object} dto.Resource{} "Resource updated" example={"id":1,"resource_group":"group1","kind":"type1","namespace":"ns1","name":"resource1","shard_id":"default","body":{"key":"new_value"},"labels":{"env":"dev"},"created_at":"2025-05-12T00:00:00Z","updated_at":"2025-05-12T01:00:00Z","version":2,"current_version":0}
// @Failure 400 {object} ErrorResponse "Invalid input" example={"error":"Validation failed: shard_id is required"}
// @Failure 500 {object} ErrorResponse "Server error" example={"error":"Failed to update resource: database error"}
...
func (h *Handler) updateResourceStatus(w http.ResponseWriter, r *http.Request) {
	var req dto.ResourceUpdateStatusOpts
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
	...
	resource, err := h.service.UpdateStatus(r.Context(), req)
	if err != nil {
